...
export class ModuleManager {
    ...
    entry(next: Function) {
        ...
        accountData.loginTime = cachData["loginTime"] || "";
        accountData.nowDate = cachData["nowDate"] || "";

        accountData.diamond = cachData["diamond"];
        this.vm.diamond = accountData.diamond;
        // this.vm.cityId = 3;
        this.vm.level = cachData["level"] == 0 ? 1 : cachData["level"];
        this.vm.levelReward = cachData["levelReward"] == 0 ? 1 : cachData["levelReward"];;
        accountData.level = this.vm.level;
        accountData.fame = {
            num: cachData["fame"] || 0,
            numE: cachData["fameE"] || 0
        };
        ...
        accountData.credit = {
            num: cachData["credit"] || 0,
            numE: cachData["creditE"] || 0
        };
        ...
        accountData.winTotal = {
            num: cachData["winTotal"] || 0,
            numE: cachData["winTotalE"] || 0
        };
